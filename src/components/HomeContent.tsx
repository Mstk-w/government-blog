...
export default function HomeContent({ posts }: HomeContentProps) {
  ...
  return (
    <div className="bg-white text-gray-800">
      ...
      <section
        data-animate
        className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white opacity-0 translate-y-8 transition-all duration-700"
      >
      ...
      <section
        data-animate
        className="py-16 opacity-0 translate-y-8 transition-all duration-700"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">専門分野</h2>
      ...
      <section
        data-animate
        className="bg-gray-50 py-16 opacity-0 translate-y-8 transition-all duration-700"
      >
